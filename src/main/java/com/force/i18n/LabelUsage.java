...
/**
 * Registry for the process-wide {@link LabelUsageTracking} implementation.
 * <p>
 * Defaults to {@link LabelUsageTracking#NONE}, so label reads cost one volatile read and one call into a
 * no-op unless an application registers a tracker.
 *
 * @see LabelUsageTracking
 * @since 1.3.7
 */
public final class LabelUsage {
    ...
    /**
     * Register the tracker to receive label reads.
     *
