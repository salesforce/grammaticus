 ...
 *
 * Based on an implementation generated from an Intl polyfill, but updated with latest CLDR updates
 * @see https://github.com/eemeli/make-plural.js
 * @author stamm
 * @since 1.1
 */
public class PluralRulesJsImpl {
    ...
    public static String getSelectFunctionOverride(Locale locale) {
        ...
        switch (locale.getLanguage()) {
            ...
            "var s = String(n).split('.'),i = s[0],v0 = !s[1],t0 = Number(s[0]) == n, n100 = t0 && s[0].slice(-2);"+
            "return i == 1 && v0 ? 'one' : !v0 || n == 0 || n != 1 && (n100 >= 2 && n100 <= 19) ? 'few' : 'other';}";
             case RUSSIAN:
             case UKRAINIAN:
